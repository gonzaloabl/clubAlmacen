                ...
                <div key={t._id} style={{...cardStyle, borderLeft: `5px solid ${t.priority === 'Urgente' ? '#e74c3c' : t.priority === 'Alta' ? '#e67e22' : '#3498db'}`}}>
                    <div style={{display:'flex', justifyContent:'space-between', alignItems:'flex-start', flexWrap:'wrap', gap:'10px'}}>
                        ...
                        <div style={{textAlign:'right', minWidth:'150px'}}>
                            ...
                            <button onClick={()=> alert("Aquí puedes abrir un modal para cambiar estado o responder")} style={{fontSize:'0.85rem', cursor:'pointer', color:'#3498db', background:'white', border:'1px solid #3498db', padding:'4px 10px', borderRadius:'4px'}}>
                                Gestionar
                            </button>
                        </div>
                    </div>
